...
window.addEventListener('load', function() {
    ...
    // Timeline for interactive preloader
    const timeline = {
        // 0-3 seconds: Only preloader animation
        0: () => {
            console.log('Preloader started');
        },
        
        // 3 seconds: Show ALL text elements
        3000: () => {
            // Show loading message
            if (loadingMessage) {
                loadingMessage.classList.add('show');
                console.log('Loading message shown at 3 seconds');
            }
            ...
            if (didYouKnowSection) {
                ...
                console.log('Did You Know section shown at 3 seconds with line-by-line animation');
            }
        },
        
        // 4 seconds: Show facts and start rotation
        4000: () => {
            if (factsSection) {
                ...
                console.log('Facts section shown and rotation started at 4 seconds');
            }
        },
        
        // 5 seconds: Show skip button
        5000: () => {
            if (skipButton) {
                skipButton.classList.add('show');
                console.log('Skip button shown at 5 seconds');
            }
        }
    };
    ...
    Object.keys(timeline).forEach(time => {
        setTimeout(timeline[time], parseInt(time));
    });
