...
function initPreloader() {
    ...
    function updateFact() {
        ...
        if (factText && factSource) {
            ...
            factSource.style.transition = 'all 0.3s ease-in';
            
            factText.style.opacity = '0';
            factText.style.transform = 'rotateX(-90deg)';
            
            factSource.style.opacity = '0';
            factSource.style.transform = 'rotateX(-90deg)';
            ...
            setTimeout(() => {
                ...
                factSource.style.transition = 'all 0.3s ease-out';
                factText.style.opacity = '1';
                factText.style.transform = 'rotateX(0deg)';
                
                factSource.style.opacity = '1';
                factSource.style.transform = 'rotateX(0deg)';
