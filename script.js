...
window.addEventListener('load', function() {
    ...
    const timeline = {
        ...
        // 4 seconds: Show "Did You Know?" section
        4000: () => {
            if (didYouKnowSection) {
                ...
                console.log('Did You Know section shown with line-by-line animation');
            }
        },
        
        // 5 seconds: Show facts and start rotation
        5000: () => {
            if (factsSection) {
                ...
                console.log('Facts section shown and rotation started');
            }
        },
        
        // 6 seconds: Show skip button
        6000: () => {
            if (skipButton) {
